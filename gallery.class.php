    ...
    function get_from_media_library($ids,$thumb_size) {
            ...
            foreach ($ids as $id) {
                ...
                if ($id != '') {
                    ...
                    $attachments[] = array(
                        'page' => esc_attr(get_attachment_link($id)),
    ...
    function shortcode($atts, $content = null, $name = null ) {
        ...
        if ($this->param_array['layout'] == 'flex') { ?>
                ...
                <?php foreach ($gallery_images as $gallery_image) {
                    ...
                    } else if ($this->param_array['link'] == 'page') {
                        $linktag = 'a';
                        if( empty( $_GET['oxygen_gutenberg_script'] ) ) {
                            $href = " href='".$gallery_image["page"]."' ";
                        }
                        else {
                            $href = " href='#'";
                        }
    ...
    function settings () { 
        ...
        <div class="oxygen-sidebar-flex-panel"
            ...
            <div ng-show="!hasOpenTabs('gallery')">
                ...
                <div class='oxygen-control-row'>
                    <div class='oxygen-control-wrapper'>
                        <label class='oxygen-control-label'><?php _e("Link Images To","oxygen"); ?></label>
                        <div class='oxygen-control'>
                            <div class='oxygen-button-list'>
                                <?php $oxygen_toolbar->button_list_button('link','file'); ?>
                                <?php $oxygen_toolbar->button_list_button('link','page'); ?>
                                <?php $oxygen_toolbar->button_list_button('link','none'); ?>
                            </div>
                        </div>
                    </div>
                </div>
